 ...
 * @subpackage PocztaPl
 */
class Email_PocztaPl extends Email_Abstract
{
    /**
    ...
    public function login($username, $pass)
    {
        ...
        $this->_client = Actor_Factory::factory('PocztaPl_Messenger', $this->_log);
        $this->_client->connection = $this->_connection;

        try {
            return $this->_client->login($username, $pass);
        } catch (Actor_Exception $e) {
            if (Actor_PocztaPl_Exception::INVALID_CREDENTIALS == $e->getCode()) {
